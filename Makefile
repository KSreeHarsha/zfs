...
am__append_1 = dracut udev etc man scripts lib cmd
am__append_2 = module
subdir = .
...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = include rpm dracut udev etc man scripts lib cmd module
...
ACLOCAL = ${SHELL} /root/ZFS_source/zfs/config/missing --run aclocal-1.11
ALIEN = alien
ALIEN_VERSION = 
AMTAR = ${SHELL} /root/ZFS_source/zfs/config/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /root/ZFS_source/zfs/config/missing --run autoconf
AUTOHEADER = ${SHELL} /root/ZFS_source/zfs/config/missing --run autoheader
AUTOMAKE = ${SHELL} /root/ZFS_source/zfs/config/missing --run automake-1.11
AWK = gawk
CC = gcc
CCAS = gcc
...
LIBUUID = -luuid
LINUX = /usr/src/kernels/2.6.32-279.14.1.el6.x86_64
LINUX_OBJ = /usr/src/kernels/2.6.32-279.14.1.el6.x86_64
LINUX_SYMBOLS = Module.symvers
LINUX_VERSION = 2.6.32-279.14.1.el6.x86_64
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /root/ZFS_source/zfs/config/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PATH_SEPARATOR = :
RANLIB = ranlib
RELEASE = 275_gbc25c93
RPM = rpm
RPMBUILD = rpmbuild
RPMBUILD_VERSION = 4.8.0
...
SET_MAKE = 
SHELL = /bin/sh
SPL = /root/ZFS_source/spl
SPL_OBJ = /root/ZFS_source/spl
SPL_SYMBOLS = Module.symvers
SPL_VERSION = 0.6.2-38_gad3412e
...
ZFS_META_ALIAS = zfs-0.6.2-275_gbc25c93
...
ZFS_META_NAME = zfs
ZFS_META_RELEASE = 275_gbc25c93
ZFS_META_VERSION = 0.6.2
ZFS_MODULE_LOAD = modules-load.d
ZLIB = -lz
abs_builddir = /root/ZFS_source/zfs
abs_srcdir = /root/ZFS_source/zfs
abs_top_builddir = /root/ZFS_source/zfs
abs_top_srcdir = /root/ZFS_source/zfs
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /root/ZFS_source/zfs/config/install-sh
...
am--refresh:
	@:
$(srcdir)/Makefile.in: # $(srcdir)/Makefile.am $(top_srcdir)/config/rpm.am $(top_srcdir)/config/deb.am $(top_srcdir)/config/tgz.am $(am__configure_deps)
	@for dep in $?; do \
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-exec-am install-extraHEADERS install-html \
	install-html-am install-info install-info-am install-man \
	install-nodist_kernelHEADERS install-pdf install-pdf-am \
	install-ps install-ps-am install-strip installcheck \
	installcheck-am installdirs installdirs-am maintainer-clean \
	maintainer-clean-generic mostlyclean mostlyclean-generic \
	mostlyclean-libtool pdf pdf-am ps ps-am tags tags-recursive \
	uninstall uninstall-am uninstall-extraHEADERS \
	uninstall-nodist_kernelHEADERS
